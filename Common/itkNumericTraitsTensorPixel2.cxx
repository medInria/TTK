...
namespace itk
{
    const Tensor<double , 2>  NumericTraits<Tensor<double, 2> >::Zero = Tensor<double , 2>( NumericTraits<double >::Zero );
    const Tensor<float , 3>  NumericTraits<Tensor<float, 3> >::Zero = Tensor<float , 3>( NumericTraits<float >::Zero );
    const Tensor<double , 3> NumericTraits<Tensor<double, 3> >::Zero = Tensor<double , 3>( NumericTraits<double >::Zero );
    const Tensor<long double , 3> NumericTraits<Tensor<long double, 3> >::Zero = Tensor<long double , 3>( NumericTraits<long double >::Zero );
    const Tensor<double , 3> NumericTraits<Tensor<double, 3> >::One = Tensor<double , 3>( NumericTraits<double>::One );
    const Tensor<float , 3>  NumericTraits<Tensor<float, 3> >::One = Tensor<float , 3>( NumericTraits<float>::One );
