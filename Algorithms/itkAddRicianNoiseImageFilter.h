...
namespace itk
{
  ...
  public:
    ...
    using Self = AddRicianNoiseImageFilter;
    using Superclass = AddGaussianNoiseImageFilter<TInputImage, TOutputImage>;
    ...
    itkTypeMacro (AddRicianNoiseImageFilter, AddGaussianNoiseImageFilter);
